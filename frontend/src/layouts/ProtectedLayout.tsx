...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/bons-livraison', label: t.nav.bonsLivraison, icon: PackageCheck },
      { to: '/situations', label: t.nav.situations, icon: FileBarChart },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/contrats-sous-traitance', label: t.nav.contratsSousTraitance, icon: FileSignature },
